...
const SITE_NAME = 'IA para Educación';
...
const TOPICS = [
  "Las Mejores Herramientas de IA para Docentes en 2026",
  "Cómo Usar ChatGPT para Planificar Clases de Forma Eficiente",
  "Herramientas de IA para Crear Exámenes y Evaluaciones Automáticas",
  "IA para Educación Especial: Herramientas de Personalización",
  "Cómo Crear Material Didáctico con Inteligencia Artificial",
  "Las Mejores Apps de IA para Comunicación con Padres de Familia",
  "IA para Calificación Automática: Comparativa Completa",
  "Cómo Usar IA para Detectar Plagio en Trabajos Estudiantiles",
  "Herramientas de IA para Crear Presentaciones Educativas",
  "IA para Aprendizaje de Idiomas en el Aula: Mejores Opciones",
  "Cómo Implementar IA en Escuelas con Presupuesto Limitado",
  "Las Mejores Plataformas de IA para Educación a Distancia",
  "IA para Tutorías Personalizadas: Herramientas que Funcionan",
  "Cómo Crear Videos Educativos con Inteligencia Artificial",
  "Herramientas de IA para Gestión del Aula y Seguimiento Estudiantil"
];
...
async function generateArticle(topic) {
  const res = await fetch(`https://generativelanguage.googleapis.com/v1beta/models/gemini-2.5-flash:generateContent?key=${GEMINI_KEY}`, {
    ...
    body: JSON.stringify({
      contents: [{ parts: [{ text: `Eres un experto en tecnología educativa que escribe en español (España/Latinoamérica). Escribe un artículo de 2000-3000 palabras sobre: ${topic}. Incluye comparaciones prácticas, precios, ventajas y desventajas. Incluye 2-3 enlaces de afiliado de Amazon: https://www.amazon.com/dp/{ASIN}?tag=${AMAZON_TAG}. Usa estos ASINs: 0593418484 (Hábitos Atómicos), 0062960067 (AI Superpowers), 0735222517 (Atomic Teaching). Solo HTML (H2,H3,tablas,listas,p). Sin etiquetas html/head/body. Responde en JSON: {"title":"...","slug":"...","excerpt":"...","content":"..."}. El slug debe estar en español con guiones. Todo el contenido DEBE estar en español.` }] }],
